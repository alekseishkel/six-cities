...
const Favorites = ({offers, isAuthorizationRequired, currentCity}) => {
  // изменять класс неймс в зависимости от страницы, сделать фейворитс баттн

  console.log(offers);
  console.log(getFavoriteOffers(offers));
  const favorites = getFavoriteOffers(offers);
